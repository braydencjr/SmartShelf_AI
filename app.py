...
init_appbar(title="🛒 SmartShelf — Enterprise Predictive Analytics", height="120px", offset="20px")

# ----------------- CSV Upload Button in Appbar -----------------
...
st.button("📁 Upload CSV", on_click=toggle_upload)
