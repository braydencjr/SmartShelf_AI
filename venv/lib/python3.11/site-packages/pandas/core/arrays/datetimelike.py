...
class DatetimeLikeArrayMixin(  # type: ignore[misc]
    ...
    def freqstr(self) -> str | None:
        ...
        >>> idx = pd.PeriodIndex(["2025-1", "2025-2", "2025-3"], freq="M")
        >>> idx.freqstr
        'M'
        """
...
_round_example = """>>> rng.round('H')
    ...
    **Series**
    ...
    >>> rng_tz = pd.DatetimeIndex(["2027-10-31 03:30:00"], tz="Europe/Amsterdam")

    >>> rng_tz.floor("2H", ambiguous=False)
    DatetimeIndex(['2027-10-31 02:00:00+01:00'],
                  dtype='datetime64[ns, Europe/Amsterdam]', freq=None)

    >>> rng_tz.floor("2H", ambiguous=True)
    DatetimeIndex(['2027-10-31 02:00:00+02:00'],
                  dtype='datetime64[ns, Europe/Amsterdam]', freq=None)
    """
...
_ceil_example = """>>> rng.ceil('H')
    ...
    **Series**
    ...
    >>> rng_tz = pd.DatetimeIndex(["2027-10-31 01:30:00"], tz="Europe/Amsterdam")
        ...
        if isinstance(values, type(self)):
            ...
            if dtype is not None:
                ...
                if dtype != values.dtype:
                    # TODO: we only have tests for this for DTA, not TDA (2028-07-01)
                    raise TypeError(
