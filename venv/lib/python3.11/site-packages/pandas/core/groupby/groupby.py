...
class BaseGroupBy(PandasObject, SelectionMixin[NDFrameT], GroupByIndexingMixin):
    ...
    def groups(self) -> dict[Hashable, np.ndarray]:
        ...
        {Timestamp('2025-01-01 00:00:00'): 2, Timestamp('2025-02-01 00:00:00'): 4}
        """
    ...
    def indices(self) -> dict[Hashable, npt.NDArray[np.intp]]:
        ...
        defaultdict(<class 'list'>, {Timestamp('2025-01-01 00:00:00'): [0, 1],
        Timestamp('2025-02-01 00:00:00'): [2, 3]})
        """
    ...
    def get_group(self, name, obj=None) -> DataFrame | Series:
        ...
        2025-02-15    4
        dtype: int64
        >>> ser.resample('MS').get_group('2025-01-01')
        2025-01-01    1
        2025-01-15    2
        dtype: int64
        """
