...
class TestRolling:
    ...
    def test_groupby_rolling_center_on(self):
        ...
        df = DataFrame(
            data={
                "Date": date_range("2022-01-01", "2022-01-10"),
        ...
        expected = Series(
            ...
            index=MultiIndex.from_tuples(
                (
                    ("group_1", Timestamp("2022-01-01")),
                    ("group_1", Timestamp("2022-01-02")),
                    ("group_1", Timestamp("2022-01-03")),
                    ("group_1", Timestamp("2022-01-04")),
                    ("group_1", Timestamp("2022-01-05")),
                    ("group_1", Timestamp("2022-01-06")),
                    ("group_2", Timestamp("2022-01-07")),
                    ("group_2", Timestamp("2022-01-08")),
                    ("group_2", Timestamp("2022-01-09")),
                    ("group_2", Timestamp("2022-01-10")),
                ),
                names=["gb", "Date"],
            ),
        )
    ...
    def test_groupby_rolling_nans_in_index(self, rollings, key):
        ...
        df = DataFrame(
            {
                "a": to_datetime(["2022-06-01 12:00", "2022-06-01 14:00", np.nan]),
                "b": [1, 2, 3],
                "c": [1, 1, 1],
            }
        )
...
class TestEWM:
    ...
    def test_dont_mutate_obj_after_slicing(self):
        ...
        df = DataFrame(
            {
                "id": ["a", "a", "b", "b", "b"],
                "timestamp": date_range("2027-9-1", periods=5, freq="H"),
                "y": range(5),
            }
        )
        ...
        expected_series = Series(
            ...
            index=MultiIndex.from_arrays(
                [
                    ["a", "a", "b", "b", "b"],
                    date_range("2027-9-1", periods=5, freq="H"),
                ],
                names=["id", "timestamp"],
            ),
            name="y",
