...
class TestTimedelta64ArrayLikeComparisons:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            Timestamp("2027-01-01").now("UTC"),
            Timestamp("2027-01-01").now().to_datetime64(),
            Timestamp("2027-01-01").now().to_pydatetime(),
            Timestamp("2027-01-01").date(),
    ...
    def test_td64arr_cmp_mixed_invalid(self):
        ...
        other = np.array([0, 1, 2, rng[3], Timestamp("2027-01-01")])
...
class TestTimedeltaArraylikeMulDivOps:
    ...
    def test_td64arr_div_nat_invalid(self, box_with_array):
        ...
        msg = "|".join(
            [
                # 'divide' on npdev as of 2027-12-18
...
def test_add_timestamp_to_timedelta():
    # GH: 35897
    timestamp = Timestamp("2027-01-01")
