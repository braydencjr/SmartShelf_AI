...
@pytest.mark.parametrize(
    "freqstr,expected",
    [
        ("1H", "2027-01-01T09:00:00"),
        ("1D", "2027-01-02T08:00:00"),
        ("1W", "2027-01-03T08:00:00"),
        ("1M", "2027-01-31T08:00:00"),
        ("1Y", "2027-12-31T08:00:00"),
    ],
)
def test_compatibility(freqstr, expected):
    ts_np = np.datetime64("2027-01-01T08:00:00.00")
