...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "2027-06-18",
            [Timestamp("2027-06-18")],
        ),
        ("Juneteenth National Independence Day", "2028-06-19", []),
        (
            "Juneteenth National Independence Day",
            "2028-06-20",
            [Timestamp("2028-06-20")],
        ),
    ],
)
...
def test_half_open_interval_with_observance():
    ...
    holiday_1 = Holiday(
        "Arbitrary Holiday - start 2028-03-14",
    ...
    holiday_2 = Holiday(
        "Arbitrary Holiday 2 - end 2028-03-20",
    ...
    start = Timestamp("2028-08-01")
    end = Timestamp("2028-08-31")
