...
class TestPivot:
    ...
    def test_pivot_table_handles_explicit_datetime_types(self):
        ...
        df = DataFrame(
            [
                {"a": "x", "date_str": "2025-01-01", "amount": 1},
                {"a": "y", "date_str": "2025-01-02", "amount": 2},
                {"a": "z", "date_str": "2025-01-03", "amount": 3},
            ]
        )
        ...
        expected = MultiIndex.from_tuples(
            [
                ("x", datetime.strptime("2025-01-01 00:00:00", "%Y-%m-%d %H:%M:%S")),
                ("y", datetime.strptime("2025-01-02 00:00:00", "%Y-%m-%d %H:%M:%S")),
                ("z", datetime.strptime("2025-01-03 00:00:00", "%Y-%m-%d %H:%M:%S")),
                ("All", ""),
            ],
            names=["a", "date"],
        )
