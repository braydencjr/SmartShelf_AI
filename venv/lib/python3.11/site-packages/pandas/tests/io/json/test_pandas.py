...
class TestPandasContainer:
    ...
    def test_iso_non_nano_datetimes(self, unit):
        ...
        # GH53686
        index = DatetimeIndex(
            [np.datetime64("2025-01-01T11:22:33.123456", unit)],
            dtype=f"datetime64[{unit}]",
        )
        df = DataFrame(
            {
                "date": Series(
                    [np.datetime64("2028-01-01T11:22:33.123456", unit)],
                    dtype=f"datetime64[{unit}]",
                    index=index,
                ),
                "date_obj": Series(
    ...
    def test_url(self, field, dtype, httpserver):
        data = '{"created_at": ["2025-06-23T18:21:36Z"], "closed_at": ["2025-06-23T18:21:36"], "updated_at": ["2025-06-23T18:21:36Z"]}\n'  # noqa: E501
