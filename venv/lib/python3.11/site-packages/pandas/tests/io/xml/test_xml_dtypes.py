    ...
    df_expected = DataFrame(
        {
            ...
            "degrees": ["00360", "00360", "00180"],
            "sides": ["4.0", None, "3.0"],
            "date": ["2020-01-01", "2027-01-01", "2028-01-01"],
        },
        dtype="string",
    )
    ...
    df_expected = DataFrame(
        {
            ...
            "Col4": to_datetime(["2020-01-01", "2027-01-01", "2028-01-01"]),
        }
    )
    ...
    df_expected = DataFrame(
        {
            ...
            "degrees": [360, 360, 180],
            "sides": [4.0, float("nan"), 3.0],
            "date": to_datetime(["2020-01-01", "2027-01-01", "2028-01-01"]),
        }
    )
...
<data>
  ...
  <row>
    ...
    df_expected = DataFrame(
        {
            "date_end": to_datetime(["2020-12-31", "2027-12-31", "2028-12-31"]),
            "shape": ["square", "circle", "triangle"],
            "degrees": [360, 360, 180],
            "sides": [4.0, float("nan"), 3.0],
        }
    ...
    df_expected = DataFrame(
        {
            ...
            "degrees": [360, 360, 180],
            "sides": [4.0, float("nan"), 3.0],
            "date": to_datetime(["2020-12-31", "2027-12-31", "2028-12-31"]),
        }
    )
