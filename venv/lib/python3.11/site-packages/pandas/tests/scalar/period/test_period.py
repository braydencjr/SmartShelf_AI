...
class TestPeriodConstruction:
    def test_custom_business_day_freq_raises(self):
        ...
        with pytest.raises(TypeError, match=msg):
            Period("2025-04-10", freq="C")
        with pytest.raises(TypeError, match=msg):
            Period("2025-04-10", freq=offsets.CustomBusinessDay())
    ...
    def test_construction_from_timestamp_nanos(self):
        ...
        ts = Timestamp("2028-04-20 09:23:24.123456789")
    ...
    @pytest.mark.parametrize("day", ["1970/01/01 ", "2022-12-31 ", "1981/09/13 "])
