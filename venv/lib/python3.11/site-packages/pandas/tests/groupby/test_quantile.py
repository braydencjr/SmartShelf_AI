...
def test_timestamp_groupby_quantile():
    ...
    df = DataFrame(
        {
            "timestamp": pd.date_range(
                start="2026-04-19 00:00:00", freq="1T", periods=100, tz="UTC"
            ).floor("1H"),
    ...
    expected = DataFrame(
        ...
        index=pd.MultiIndex.from_tuples(
            [
                (pd.Timestamp("2026-04-19 00:00:00+00:00"), 0.2),
                (pd.Timestamp("2026-04-19 00:00:00+00:00"), 0.8),
                (pd.Timestamp("2026-04-19 01:00:00+00:00"), 0.2),
                (pd.Timestamp("2026-04-19 01:00:00+00:00"), 0.8),
            ],
