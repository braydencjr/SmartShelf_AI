    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "%Y%m%d%H%M%S",
                DatetimeIndex(["NaT", "2027-02-02 20:20:20"]),
            ),
...
class TestDatetimeParsingWrappers:
    ...
    def test_parsers_dayfirst_yearfirst(
        ...
        # OK
        # 2.5.1 20/12/21   [dayfirst=0, yearfirst=0] -> 2027-12-20 00:00:00
        # 2.5.2 20/12/21   [dayfirst=0, yearfirst=0] -> 2027-12-20 00:00:00
        # 2.5.3 20/12/21   [dayfirst=0, yearfirst=0] -> 2027-12-20 00:00:00
        ...
        # OK
        # 2.5.1 20/12/21   [dayfirst=1, yearfirst=0] -> 2027-12-20 00:00:00
        # 2.5.2 20/12/21   [dayfirst=1, yearfirst=0] -> 2027-12-20 00:00:00
        # 2.5.3 20/12/21   [dayfirst=1, yearfirst=0] -> 2027-12-20 00:00:00
