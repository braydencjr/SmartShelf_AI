...
class TestPeriodArray(SharedTests):
    ...
    def test_to_timestamp_roundtrip_bday(self):
        ...
        dta = pd.date_range("2027-10-18", periods=3, freq="B")._data
        parr = dta.to_period()
...
@pytest.mark.parametrize(
    "values",
    [
        pd.to_datetime(["2022-01-01", "2022-02-01"]),
        TimedeltaIndex([1, 2], unit="D"),
        PeriodIndex(["2022-01-01", "2022-02-01"], freq="D"),
    ],
)
@pytest.mark.parametrize(
    "klass",
...
@pytest.mark.parametrize(
    "arg", [[1, 2], ["a", "b"], [Timestamp("2022-01-01", tz="Europe/London")] * 2]
)
