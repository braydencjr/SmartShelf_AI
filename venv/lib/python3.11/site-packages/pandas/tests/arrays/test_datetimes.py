...
class TestDatetimeArray:
    ...
    def test_setitem_str_impute_tz(self, tz_naive_fixture):
        ...
        ts = pd.Timestamp("2022-09-08 16:50").tz_localize(tz)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pd.Timestamp("2027-01-01").to_datetime64(),
            pd.Timestamp("2027-01-01").to_pydatetime(),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pd.Timestamp("2027-01-01").to_period("D"),
        ],
    )
    @pytest.mark.parametrize("index", [True, False])
    ...
    def test_shift_requires_tzmatch(self):
        ...
        fill_value = pd.Timestamp("2022-10-18 18:44", tz="US/Pacific")
