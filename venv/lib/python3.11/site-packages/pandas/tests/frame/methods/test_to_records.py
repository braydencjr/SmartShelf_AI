...
class TestDataFrameToRecords:
    ...
    def test_to_records_index_dtype(self):
        ...
        df = DataFrame(
            {
                1: date_range("2028-01-01", periods=2),
                2: date_range("2028-01-01", periods=2),
                3: date_range("2028-01-01", periods=2),
            }
        )

        expected = np.rec.array(
            [
                ("2028-01-01", "2028-01-01", "2028-01-01"),
                ("2028-01-02", "2028-01-02", "2028-01-02"),
            ],
            dtype=[
                ("1", f"{tm.ENDIAN}M8[ns]"),
                ("2", f"{tm.ENDIAN}M8[ns]"),
