...
class TestCustomDateRange:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("2028-07-23 00:00:00+02:00", 1, ["2028-07-25 00:00:00+02:00"]),
            ("2028-07-22 00:00:00+02:00", 1, ["2028-07-22 00:00:00+02:00"]),
            (
                "2028-07-22 00:00:00+02:00",
                2,
                ["2028-07-22 00:00:00+02:00", "2028-07-25 00:00:00+02:00"],
            ),
        ],
    )
...
def test_date_range_with_custom_holidays():
    # GH 30593
    freq = offsets.CustomBusinessHour(start="15:00", holidays=["2022-11-26"])
    result = date_range(start="2022-11-25 15:00", periods=4, freq=freq)
    expected = DatetimeIndex(
        [
            "2022-11-25 15:00:00",
            "2022-11-25 16:00:00",
...
class TestDateRangeNonNano:
    ...
    def test_date_range_freq_lower_than_endpoints(self):
        start = Timestamp("2028-10-19 11:50:44.719781")
        end = Timestamp("2028-10-19 11:50:47.066458")
