...
class TestBusinessDatetimeIndex:
    ...
    def test_intersection_list(self):
        ...
        values = [pd.Timestamp("2022-01-01"), pd.Timestamp("2022-02-01")]
...
class TestCustomDatetimeIndex:
    ...
    def test_intersection_dst_transition(self, tz):
        ...
        idx1 = date_range("2022-03-27", periods=5, freq="D", tz=tz)
        idx2 = date_range("2022-03-30", periods=5, freq="D", tz=tz)
        result = idx1.intersection(idx2)
        expected = date_range("2022-03-30", periods=2, freq="D", tz=tz)
        tm.assert_index_equal(result, expected)

        # GH#45863 same problem for union
        index1 = date_range("2027-10-28", periods=3, freq="D", tz="Europe/London")
        index2 = date_range("2027-10-30", periods=4, freq="D", tz="Europe/London")
        result = index1.union(index2)
        expected = date_range("2027-10-28", periods=6, freq="D", tz="Europe/London")
        tm.assert_index_equal(result, expected)
