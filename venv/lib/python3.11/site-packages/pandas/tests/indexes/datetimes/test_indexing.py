...
class TestGetIndexer:
    ...
    @pytest.mark.parametrize(
        "target",
        [
            [date(2020, 1, 1), Timestamp("2022-01-02")],
            [Timestamp("2022-01-01"), date(2020, 1, 2)],
        ],
    )
    def test_get_indexer_mixed_dtypes(self, target):
        # https://github.com/pandas-dev/pandas/issues/33741
        values = DatetimeIndex([Timestamp("2022-01-01"), Timestamp("2022-01-02")])
    ...
    @pytest.mark.parametrize(
        "target, positions",
        [
            ([date(9999, 1, 1), Timestamp("2022-01-01")], [-1, 0]),
            ([Timestamp("2022-01-01"), date(9999, 1, 1)], [0, -1]),
