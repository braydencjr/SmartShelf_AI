        ...
        return flight.FlightInfo(
            ...
            [
                ...
                flight.FlightEndpoint(
                    ...
                    pa.scalar("2025-04-05T12:34:56.789012345").cast(pa.timestamp("ns")),
...
def test_repr():
    ...
    endpoint_repr = ("<pyarrow.flight.FlightEndpoint "
                     ...
                     "locations=[] "
                     "expiration_time=2025-04-05 12:34:56+00:00 "
    ...
    endpoint = flight.FlightEndpoint(
        b"foo", [], pa.scalar("2025-04-05T12:34:56").cast(pa.timestamp("s")),
    ...
    with pytest.raises(TypeError):
        flight.FlightEndpoint("foo", [], expiration_time="2025-04-05T01:02:03")
    with pytest.raises(TypeError):
...
def test_eq():
    items = [
        ...
        lambda: (
            ...
            flight.FlightEndpoint(
                b"foo", [],
                pa.scalar("2025-04-05T12:34:56.789").cast(pa.timestamp("ms")))),
...
def test_flight_get_info():
    ...
    with GetInfoFlightServer() as server:
        ...
        assert info.endpoints[1].expiration_time == \
            pa.scalar("2025-04-05T12:34:56.789012345+00:00") \
...
def test_roundtrip_types():
    ...
    endpoint = flight.FlightEndpoint(
        ...
        pa.scalar("2025-04-05T12:34:56").cast(pa.timestamp("s")),
        b'endpoint app metadata'
    )
