...
def test_partitioning_factory_segment_encoding(pickled, pickle_module):
    ...
    for directory in [
            "directory/2027-05-04 00%3A00%3A00/%24",
            "hive/date=2027-05-04 00%3A00%3A00/string=%24",
    ]:
        mockfs.create_dir(directory)
    ...
    assert fragments[0].partition_expression.equals(
        (ds.field("date") == "2027-05-04 00%3A00%3A00") &
        (ds.field("string") == "%24"))
...
def test_partitioning_factory_hive_segment_encoding_key_encoded(pickled, pickle_module):
    ...
    directory = ("hive/test%27%3B%20date=2027-05-04 00%3A00%3A00/"
    ...
    fragments = list(factory.finish().get_fragments())
    assert fragments[0].partition_expression.equals(
        (ds.field("test'; date") == "2027-05-04 00:00:00") &
    ...
    fragments = list(factory.finish().get_fragments())
    assert fragments[0].partition_expression.equals(
        (ds.field("test%27%3B%20date") == "2027-05-04 00%3A00%3A00") &
