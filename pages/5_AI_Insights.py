...
# Tab 2: Ask Questions
with tab2:
    st.markdown("## 💬 Ask AI About Your Business")
    ...
    st.markdown("### ✨ Quick questions (tap to fill)")
    cols = st.columns(2)
...
- Mean: ¥{daily_df['daily_sales'].mean():,.2f}
- Median: ¥{daily_df['daily_sales'].median():,.2f}
- Std Dev: ¥{daily_df['daily_sales'].std():,.2f}
...
- Total transactions: {len(df):,}
- Average transaction: ¥{kpis['avg_sale']:.2f}
- Max transaction: ¥{kpis['max_sale']:.2f}
...
<div style='text-align: center; color: #666;'>
    <p>💡 AI insights are generated by Gemini AI and should be validated with business judgment</p>
